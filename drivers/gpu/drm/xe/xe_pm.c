 ...
 * @xe: xe device instance
 *
 * Returns: True if device is awake (regardless the previous number of references)
 ...
 * @xe: xe device instance
 *
 * Returns: True if device is awake, a previous reference had been already taken,
